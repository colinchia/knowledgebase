...
import { createTopic } from "src/utils/AppApiInterfacers";
...
function ManageTopicsModalCreate() {
    ...
    const [topicIcon, setTopicIcon] = useState<Icon>({ iconPrefix: "far", iconName: "lightbulb" });
    ...
    const handleCreate = () => {
        ...
        if (Object.keys(fieldErrors).length === 0) {
            ...
            createTopic(formData, 
                (data) => {
                    process.env.NODE_ENV === "development" && console.log("Success: Topic created: ", data);
                    closeModal();
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered">
                <div className="modal-content kwb-formgroup">
                    <AppStyles.ThemedModalHeader theme={theme} className="modal-header">
                        <h2 className="modal-title">Create Topic</h2>
...
export default ManageTopicsModalCreate;
